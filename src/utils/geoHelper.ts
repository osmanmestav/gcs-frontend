...
var geoHelper = {
	...
	mapAngleToPIRange: function(angle: any) { while (angle > 180) angle -= 360; while (angle <= -180) angle += 360; return angle; },

	// Following functions are adapted from http://www.movable-type.co.uk/scripts/latlong.html

	// Receives and returns degrees
	getBearing: function(lat1: any, lng1: any, lat2: any, lng2: any)
	{
	...
	getDistance: function(lat1: any, lng1: any, lat2: any, lng2: any)
	{
		lat1 = this.toRadians(lat1);
		lat2 = this.toRadians(lat2);
	...
	getDestination: function(lat: any, lon: any, bearing: any, distance: any)
	{
