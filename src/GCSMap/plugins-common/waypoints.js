...
function refreshLoiter(waypoint, material) {
        ...
        waypoint.circle = viewer.entities.add({
            ...
            ellipse: {
                semiMinorAxis: new Cesium.CallbackProperty(function () {
                    return waypoint.loiterRadius;
                }, false),
                semiMajorAxis: new Cesium.CallbackProperty(function () {
                    return waypoint.loiterRadius;
                }, false),
                extrudedHeight: new Cesium.CallbackProperty(function () {
                    return waypoint.data.altitude;
                }, false),
    ...
    } else if (waypoint.circle && !isLoiter) {
        viewer.entities.remove(waypoint.circle);
        waypoint.circle = null;
    }
}

if (window.csharp.isMissionEditable === true) window.addEventListener("WaypointChanged", (e) => refreshWaypoint(e.detail));
